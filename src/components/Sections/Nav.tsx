  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="relative ml-auto sm:ml-0 cursor-pointer">
          <svg
          ...
          {cart.length && (
            <span className="absolute -top-3 -right-3 rounded-full h-5 w-5 flex justify-center items-center text-white bg-main ">
